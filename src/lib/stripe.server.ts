...
/** Stripe SDK client whose transport is proxied through the Lovable connector gateway. */
...
/** Verifies a Stripe webhook signature without depending on the SDK's node crypto path. */
