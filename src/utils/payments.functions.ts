 ...
 * billing portal, dashboards, subscription search — can find them by userId.
 */
...
/** Creates an embedded checkout session for a human-readable price ID. */
export const createCheckoutSession = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<CheckoutSessionResult> => {
    try {
      ...
      if (data.serviceTitle) metadata["serviceTitle"] = data.serviceTitle;
