    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/blog/ai-business-tools-for-women", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/how-to-price-your-services", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/grant-application-checklist", changefreq: "monthly", priority: "0.7" },
